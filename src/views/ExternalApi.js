...
export const ExternalApiComponent = () => {
  ...
  const callApi = async () => {
    try {
      ...
      console.log('Here!');
      const response = await fetch(`${process.env.REACT_APP_API_ORIGIN}/api/external`, {
        headers: {
      ...
      setState({
        ...state,
        error: error.message + ` when calling ${process.env.REACT_APP_API_ORIGIN}/api/external`,
      });
    }
  };
